...
main() {
  ...
  mkdir -p /srv/games /srv/games/snake /srv/games/maze /srv/games/comet /srv/games/wallmover /srv/games/archimedes /srv/games/fling /srv/games/typing /srv/games/gameroom
